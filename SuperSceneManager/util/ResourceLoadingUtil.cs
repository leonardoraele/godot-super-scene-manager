...
{
	public static async Task<PackedScene> LoadSceneAsync(
		string scenePath,
		Action<Variant>? updateProgress = null,
		...
		ResourceLoader.LoadThreadedRequest(scenePath, nameof(PackedScene), useSubThreads, cacheMode);
		void OnProcessFrame() {
